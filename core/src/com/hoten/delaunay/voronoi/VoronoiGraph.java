...
//        });
        ...
        for (Edge e: edges) {
            if ((e.v0 == null) || (e.v1 == null)) continue;
            e.setVornoi(e.v0, e.v1);
        }
    }
    ...
    private void drawPolygon(Graphics2D g, Center c, Color color) {
        ...
        for (Center n : c.neighbors) {
            ...
            if (e.v0 == null) {
                //outermost com.hoten.delaunay.voronoi edges aren't stored in the graph
                continue;
            }
    ...
    //also records the area of each com.hoten.delaunay.voronoi cell
