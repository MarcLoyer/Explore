 ...
 */
public class XoppaBulletScreen implements Screen {
    ...
    public XoppaBulletScreen(ExploreGame g) {
        game = g;
        manager = g.manager;
        skin = g.skin;
        batch = g.batch;
    ...
    public void render(float del) {
        ...
        instances.get("ground").transform.setTranslation(0, MathUtils.sinDeg(angle) * 2.5f, 0f);
